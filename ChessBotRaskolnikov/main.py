...
class Game:
    ...
    def new(self):
        ...
        self.board = fenToBoard(self,self.board,"rnbqkbnr/pp1ppppp/8/2p5/4P3/8/PPPP1PPP/RNBQKBNR w KQkq c6 0 2")
    ...
    def makeMove(self,startCounter,endCounter):
        ...
        self.board[s] = None
        print(counterToPos(s),counterToPos(e),self.moveCount)
        if self.board[e]:
            self.board[e].kill()
        else:
            self.board[e] = tempPiece
        self.moveCount += 1
